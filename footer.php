	...
	<div class="credits section bg-dark no-padding">
		...
		<div class="credits-inner section-inner">
			...
			<p class="credits-right">
				...
				<span><? //php printf( __( 'Theme by <a href="%s">Anders Noren</a>', 'hemingway'), 'http://www.andersnoren.se' ); ?></span> <a title="<?php _e('To the top', 'hemingway'); ?>" class="tothetop"><?php _e('Up', 'hemingway' ); ?> &uarr;</a>
